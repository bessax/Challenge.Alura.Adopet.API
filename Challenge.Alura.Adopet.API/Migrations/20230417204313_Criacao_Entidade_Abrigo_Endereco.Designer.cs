...
namespace Challenge.Alura.Adopet.API.Migrations
{
    ...
    [Migration("20230417204313_Criacao_Entidade_Abrigo_Endereco")]
    partial class Criacao_Entidade_Abrigo_Endereco
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Challenge.Alura.Adopet.API.Dominio.Abrigo", b =>
                {
                    b.HasOne("Challenge.Alura.Adopet.API.Dominio.Endereco", "Endereco")
                        .WithOne("Abrigo")
                        .HasForeignKey("Challenge.Alura.Adopet.API.Dominio.Abrigo", "EnderecoId")
